...
export function Detail( { job } : { job : IJob}  ) {
    return (
        ...
        <>
            { 
                job && job.status.toUpperCase() == 'CLOSE' && 
                <div className="items-center justify-center flex flex-col shadow-2xl p-4 m-8 rounded-2xl h-[500px]">
                    <div>
                        <Image src="/images/job_not_available.png" alt="Job Closed" width={400} height={500} className="mx-auto" />
                        <h1 className='text-center text-red-600 font-bold text-[30px] mt-[20px]'> 
                            This job is not available right now. Thanks for visiting our website.
                        </h1>
                    </div>
                        ...
                        <div>
                            <Link href="/">
                                <button className='w-full p-2 font-bold text-white uppercase bg-purple-600 rounded-md hover:bg-purple-400 hover:cursor-pointer' >
                                    Discover Exciting Job Opportunities Here            
                                </button>
                            </Link>    
                        </div>
                    </div>
